...
def main(gff_file,pan_centro_bed_file,centro_stat,inter_v_ltr:str,ltr_length_file,fol):
    ...
    with open(file,'r') as gffile:
        ...
        for i in gffile:
            ...
            # xx=seq_name if intact_ratio > 1.3 else None
            # print(xx)
            ...
            if ful_state:
                ...
                if c_index <= len(target_motif)-3 and \
                    ...
                    while (cal_name in [ltr_name,inter_name,'SAT-2_OS'] or '(' in cal_name) and\
                            cal_gapR < 0.1 and max(acculate_dic.values()) < 1.4 and \
                    ...
                    print(unit_list)
                    print(target_motif[cal_index][cal_name][1])
                    print(acculate_dic)
                    if max(acculate_dic.values())>=1.4:
                        unit_list.pop()
...
if __name__ == "__main__":
    ...
    gff_file=r'E:\Bio_analysis\Weedyrice\pan_weedyrice\pan_gff_set\ZS97rmfup_replaced.gff3'
    # pan centro bed
    ...
    # fol=sys.argv[6]
    fol='freq'
    main(gff_file,pan_centro_bed_file,True,inter_v_ltr,ltr_length_file,fol)
    # main(gff_file,pan_centro_bed_file,False,inter_v_ltr,ltr_length_file,fol)
    # fol='length'
    # main(gff_file,pan_centro_bed_file,True,inter_v_ltr,ltr_length_file,fol)
    # main(gff_file,pan_centro_bed_file,False,inter_v_ltr,ltr_length_file,fol)